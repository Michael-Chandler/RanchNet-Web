				...
				<div class="form-group">
					<div class="form-row">
						<div class="col-md-6">
							...
							<input style="height:50px;width:200px" class="form-control" id="cattleId" name="cattleId" type="text" aria-describedby="nameHelp" placeholder="Cattle ID here">
						</div>
					</div>
				</div>
				<button style="height:50px;width:200px" type="submit" class="btn btn-secondary form-control" id="pair" name="pair">Find Pair</button>
				</form>
