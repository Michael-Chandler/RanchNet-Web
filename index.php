...
<header class="masthead">
    <div class="container">
        <div class="intro-text">
            <div class="intro-lead-in">Welcome to RanchNet!</div>
            <div class="intro-heading">Your Cattle Record Keeping Solution.</div>
            <a class="btn btn-primary js-scroll-trigger" href="#features">Tell Me More</a>
            <a class="btn btn-secondary js-scroll-trigger" href="login">Sign Up</a>
        </div>
    </div>
</header>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <span class="copyright">Copyright &copy; RanchNet 2017</span>
            </div>
            <div class="col-md-4">
                <ul class="list-inline social-buttons">
                    <li class="list-inline-item">
